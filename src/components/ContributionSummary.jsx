...
const ContributionSummary = (props) => {
  ...
  return (
    <>
      {totalContributions && (
        <div className={`summarySection w-[95%] msm:w-[85%] gsm:w-[75%] md:w-[95%] flex flex-col gap-[0.5rem] justify-center items-center p-[0.5rem] vsm:px-[1rem] py-[2rem] md:px-0 mt-[2rem] relative bg-darkGrey rounded-[0.625rem] ${scrollClass}`}>
